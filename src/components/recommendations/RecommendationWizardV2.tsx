            ...
            case 0: // INTRO
                return (
                    <div className="flex flex-col items-center text-center space-y-6 md:space-y-8 max-w-lg md:max-w-2xl px-6">
                        ...
                        <button 
                            onClick={nextStep}
                            className="mt-6 md:mt-8 px-8 py-4 md:px-10 md:py-5 bg-avans-red text-white text-lg md:text-xl font-bold rounded-full hover:scale-105 hover:shadow-xl hover:shadow-red-500/30 transition-all flex items-center gap-3"
                        >
                ...
                return (
                    <div className="w-full max-w-2xl px-4 md:px-6 space-y-6 md:space-y-8">
                        ...
                        <div className="flex justify-between items-center pt-4 md:pt-8 gap-4">
                             <button onClick={prevStep} className="text-gray-400 hover:text-gray-600 font-medium px-4 py-2 text-sm md:text-base">Terug</button>
                             <button 
                                onClick={nextStep}
                    ...
                    <div className="w-full max-w-3xl px-4 md:px-6 space-y-8 md:space-y-12">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                         ...
                         <div className="flex justify-between items-center pt-8">
                             <button onClick={prevStep} className="text-gray-400 hover:text-gray-600 font-medium px-4 py-2">Terug</button>
                             <button 
                                onClick={nextStep}
